...
- **Cross-Platform Support**: Works on macOS, and Linux, ensuring accessibility across different operating systems.
...
.. note::
   ...
   This should be the intro to the whole thing. Have a more elaborate "About" section somewhere maybe.
...
Include a table or structure here or something for fast movement.
